...
class EmqxWebSocketController extends Controller
{
    ...
    {
        Log::info("IMAGE_HANDLER_HIT", ["topic" => $request->topic]);
        $topic = $request->topic;
    ...
    {
        Log::info("STATUS_HANDLER_HIT", ["topic" => $request->topic]);
        preg_match(
            '/ws\/camera\/(.+)\/status/',
            $request->topic ?? '',
            $matches
    ...
    {
        Log::info("OTA_HANDLER_HIT", ["topic" => $request->topic]);
    ...
    {
        Log::info("CONFIG_HANDLER_HIT", ["topic" => $request->topic]);
