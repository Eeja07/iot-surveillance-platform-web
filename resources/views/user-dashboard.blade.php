    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateClientSideStates() {
            ...
            allCameraCards.forEach(card => {
                ...
                // Update Status Badge on Header Card
                                ...
                                @foreach($groupCameras as $camera)
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4 col-xl-3 camera-card"
                                        ...
                                        <div class="card h-100 shadow-sm border-0">
                                            ...
                                            <span id="camera-status-{{ $camera->id }}" class="d-none"></span>

                                            <div class="card-header d-flex justify-content-between align-items-center bg-transparent border-0 pb-0 px-3 pt-3">
                                                <div class="min-w-0">
                                                    <h6 class="card-title mb-0 fw-bold text-truncate" style="max-width: 100%;">{{ $camera->name }}</h6>
                                                    @if($camera->group)
                                            ...
                                            <div class="card-footer d-flex justify-content-between align-items-center bg-transparent border-top py-2 px-3">
                                                <button type="button" class="btn btn-xs btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#telemetryModal-{{ $camera->id }}">
                                                    Health Details
                                                </button>
                    ...
                    <div class="d-flex align-items-start justify-content-between w-100">
                        <div class="content-left">
                            ...
                            <h3 class="mb-0 mt-1 fw-bold">
                                <span id="summary-online">{{ $onlineCameras ?? 0 }}</span> / <span class="summary-total-denominator text-muted">{{ $totalCameras ?? 0 }}</span>
                            </h3>
                            <small class="text-muted fw-semibold" id="summary-online-percent">{{ $onlinePercent }}%</small>
                        </div>
                        <span class="badge bg-label-secondary border rounded p-2">
                ...
                <div class="card-body d-flex flex-column justify-content-between p-3">
                    <div class="d-flex align-items-start justify-content-between w-100">
                        <div class="content-left">
                            ...
                            <h3 class="mb-0 mt-1 fw-bold">
                                <span id="summary-warning">{{ $warningCameras ?? 0 }}</span> / <span class="summary-total-denominator text-muted">{{ $totalCameras ?? 0 }}</span>
                            </h3>
                            <small class="text-muted fw-semibold" id="summary-warning-percent">{{ $warningPercent }}%</small>
                        </div>
                        <span class="badge bg-label-secondary border rounded p-2">
                ...
                <div class="card-body d-flex flex-column justify-content-between p-3">
                    <div class="d-flex align-items-start justify-content-between w-100">
                        <div class="content-left">
                            ...
                            <h3 class="mb-0 mt-1 fw-bold">
                                <span id="summary-offline">{{ $offlineCameras ?? 0 }}</span> / <span class="summary-total-denominator text-muted">{{ $totalCameras ?? 0 }}</span>
                            </h3>
                            <small class="text-muted fw-semibold" id="summary-offline-percent">{{ $offlinePercent }}%</small>
                        </div>
                        <span class="badge bg-label-secondary border rounded p-2">
